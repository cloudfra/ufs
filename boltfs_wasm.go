...
// boltFSPrefix mirrors the constant in boltfs.go so isBoltFSUri keeps
// recognizing bolt: URIs (and reporting the right error) even though the
// backend itself is unavailable on this platform; see the package comment
// below.
